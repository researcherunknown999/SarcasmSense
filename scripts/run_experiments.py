...
def main() -> None:
    ...
    ap.add_argument("--exp_config", type=str, default="configs/experiments_table4.yaml")
    ap.add_argument("--data_root", type=str, required=True)
    ap.add_argument("--out_root", type=str, default="artifacts/runs")
    ap.add_argument("--device", type=str, default="cuda")
    ap.add_argument("--seeds", type=int, nargs="*", default=None, help="Override seeds in exp_config")
    args = ap.parse_args()
